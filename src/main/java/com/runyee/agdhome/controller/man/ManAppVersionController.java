 ...
 */
@RestController
@RequestMapping("/man/version")
@UrlSkip(value = "man_version",skip = Skip.MAN)
public class ManAppVersionController {
     ...
     *  应用平台
     * */
    @RequestMapping(value="/plats", method = RequestMethod.POST)
    public AppJson plats(){
        AppJson app = new AppJson();
        String appcode = service.plats(app);
    ...
    public AppJson list(ManAppVersionPageBean pageBean){
        AppJson app = new AppJson();
    ...
    public AppJson issue(AppVersionForm formBean){
        AppJson app = new AppJson();
