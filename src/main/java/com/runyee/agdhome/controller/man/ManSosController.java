 ...
 */
@RestController
@RequestMapping("/man/sos")
@UrlSkip(value = "man_sos",skip = Skip.MAN)
public class ManSosController {
    @Autowired
    ...
    public AppJson schedules(HttpServletRequest request){
    ...
    public AppJson list(ManSosPageBean pageBean){
        AppJson app = new AppJson();
    ...
    public AppJson confirm(SosHandleForm form){
        AppJson app = new AppJson();
    ...
    public AppJson inform(SosHandleForm form){
        AppJson app = new AppJson();
        String appcode = service.inform(form,app);
        if(APPCode.codeMap.containsKey(appcode)){
            //原编码返回
            app.setSuccess(appcode);
            if(!APPCode.SUCCESS.equals(appcode)){
