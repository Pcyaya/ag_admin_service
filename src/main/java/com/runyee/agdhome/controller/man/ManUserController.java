...
@UrlSkip(value = "man_user",skip = Skip.MAN)
public class ManUserController {
    ...
    public AppJson pwd(HttpServletRequest request){
        AppJson app = new AppJson();
        String old_pwd = request.getParameter("old_pwd");
        String new_pwd = request.getParameter("new_pwd");
        String repeat_pwd = request.getParameter("repeat_pwd");
        String appcode = service.pwd(old_pwd,new_pwd,repeat_pwd,app);
    ...
    public AppJson baseinfo(HttpServletRequest request){
        AppJson app = new AppJson();
        String appcode = service.base_info(app);
        if(APPCode.codeMap.containsKey(appcode)){
            //原编码返回
            app.setSuccess(appcode);
            if(!APPCode.SUCCESS.equals(appcode)){
    ...
    /**
     * 18.用户 autocomplete 列表
     * */
    @RequestMapping(value="/auto", method = RequestMethod.POST)
    public AppJson auto(ManAutoUserPageBean pageBean){
        AppJson app = new AppJson();
    ...
    public AppJson list(ManUserPageBean pageBean){
        AppJson app = new AppJson();
    ...
    public AppJson issue(UserForm formBean){
        AppJson app = new AppJson();
